...
1. Before making any changes to your code, go to your repo in GitHub and create a new branch called "Level 1" so you can have a version of the code as it was before you started this next assignment.  You can now continue on your `main` branch for Level 2.  It is fine that your project name is the same, but make sure you are not working in the Level 1 branch before proceeding.
...
Answer the questions in [Gradescope]({{ site.data.externallinks.gradescope }}) under "Unity - Level 2: Collision and Physics" regarding your project [5 XP].
...
1. Before making any changes to your code, go to your repo in GitHub and create a new branch called "Level 2" so you can have a version of the code as it was before you started this next assignment.  You can now continue on your `main` branch for Level 3.  It is fine that your project is still called Level 1. Make sure, before proceeding, that you are back in the "main" branch.
2. Using a [Tilemap](https://learn.unity.com/tutorial/introduction-to-tilemaps), create a "level" for your character to explore.  This level's map should be "larger" than the initial screen, and the camera should "scroll" to follow the player. [Official Tilemap Documentation](https://docs.unity3d.com/Manual/Tilemap.html)
   * Working level map made out of tiles  [20 XP]
   * Use all three of the platforms/boxes that you had from level 2 [10 XP]
   * Have a way for the level to "end" (game over, winning, whatever) [10 XP]
   * Having a "map" that is larger than the initial screen, with a camera that moves with the player. [5 XP]
   * Bonus!  Have more than one map that the user can choose from a menu or pause screen! [10 XP]
   * Bonus!  Add things to collect, like coins, and a counter on the screen that shows how many you collected! [10 XP]

If you are looking for spritesheets and assets there are MANY available at [https://itch.io/game-assets](https://itch.io/game-assets) for free or for a small price/donation.

There are lots of resources you can use to learn how to use Tiled with Unity. Here is the [official Tilemap Documentation](https://docs.unity3d.com/Manual/Tilemap.html). Your tilemap resource file (that is, the file you used to create your tiles), as well as the "layout" of your level must be pushed to Github.
...
Answer the questions in [Gradescope]({{ site.data.externallinks.gradescope }}) under "Unity - Level 3: Tiled Level Design" regarding your project [5 XP].
...
We will also be demoing these in class on Tuesday March 26.  Make sure yours is ready by then!  (The final version of the document is not due until 11:59 that night.)
